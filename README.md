...
The only problem now is that once we don't see where on the map we clicked. To fix this, we can add a special OpenLayers layer, called marker layer, to show the choose location.
